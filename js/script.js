...
function findCity() {
    ...
    var apiURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=imperial&appid=2b72ac2d0290bb3a4bdc082b2b933f81";
...
// Fetches data for a city in the list, assuming existence is pre-validated.
...
// Updates weather details and UV index classification on the UI.
...
// Populates 5-day forecast data on the page.
...
// Convert server UNIX time to a readable date.
...
// Handles city selection from list and fetches weather data.
